...
- Sandbox automation: `bash /Users/ryua/code/mcp_sandbox/scripts/factory_auto.sh --token <TOKEN> --repo-id Slackbot --repo-name Slackbot --branch "$(git rev-parse --abbrev-ref HEAD)"`
